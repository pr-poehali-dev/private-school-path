        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="section-fade space-y-4">
              ...
              <a
                href="https://cdn.poehali.dev/projects/c9fb471b-567a-4bfb-bdc0-b51d4bb4ad8e/bucket/docs/programma-podgotovka-k-shkole.docx"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 bg-white rounded-2xl p-5 border border-gray-100 card-hover hover:bg-gray-50 transition-colors"
              >
                ...
                <div>
                  <div className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Программа</div>
                  <div className="font-semibold text-gray-900">Подготовка к школе</div>
                  <div className="text-gray-400 text-sm mt-0.5">DOCX</div>
                </div>
              </a>
              <a
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              <a href="https://vk.ru/club238238234" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors" title="ВКонтакте">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M15.684 0H8.316C1.592 0 0 1.592 0 8.316v7.368C0 22.408 1.592 24 8.316 24h7.368C22.408 24 24 22.408 24 15.684V8.316C24 1.592 22.408 0 15.684 0zm3.692 17.123h-1.744c-.66 0-.862-.523-2.049-1.712-1.033-1.01-1.49-1.135-1.744-1.135-.356 0-.458.102-.458.593v1.558c0 .424-.135.677-1.254.677-1.846 0-3.896-1.118-5.335-3.202C4.624 10.857 4 8.408 4 7.932c0-.254.102-.491.593-.491h1.744c.44 0 .61.203.78.677.863 2.49 2.303 4.675 2.896 4.675.22 0 .322-.102.322-.66V9.721c-.068-1.186-.695-1.287-.695-1.71 0-.204.17-.407.44-.407h2.744c.373 0 .508.203.508.643v3.473c0 .372.17.508.271.508.22 0 .407-.136.813-.542 1.254-1.405 2.151-3.574 2.151-3.574.119-.254.322-.491.763-.491h1.744c.525 0 .644.27.525.643-.22 1.017-2.354 4.031-2.354 4.031-.186.305-.254.44 0 .78.186.254.796.779 1.203 1.254.745.847 1.32 1.558 1.473 2.049.17.474-.085.712-.576.712z"/></svg>
              </a>
              <a href="https://t.me/edu_science_up" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors" title="Telegram">
