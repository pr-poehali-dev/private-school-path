...
export const TEACHERS = [
  ...
  {
    name: "Шубернецкая Екатерина Валерьевна",
    role: "Учитель высшей категории",
    photo: "https://cdn.poehali.dev/projects/c9fb471b-567a-4bfb-bdc0-b51d4bb4ad8e/bucket/73a4f639-6c69-4f29-9c88-5864508d4dff.png",
    subjects: ["педагогика", "психология", "развитие детей"],
    facts: [
      "Учитель высшей категории с многолетним опытом работы",
      "Глубокие знания в области педагогики и психологии, современные методики обучения",
      "Находит индивидуальный подход к каждому ученику",
      "Уроки отличаются профессионализмом, доброжелательной атмосферой и высокой результативностью",
      "Особое внимание уделяет развитию интеллектуальных способностей и творческого потенциала",
      "Активный участник образовательных проектов и методической деятельности",
      "Пользуется заслуженным уважением среди коллег, учеников и родителей",
    ],
    diplomas: [],
